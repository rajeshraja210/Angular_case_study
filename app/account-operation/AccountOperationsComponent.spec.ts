...
describe('Open Account button', () => {
  it('should be disabled when accountId is not provided', injectAsync([AccountOperationsComponent], (tcb) => {
  ...
  it('should be disabled if accountId already exists', injectAsync([AccountOperationsComponent], (tcb) => {
    return tcb.createAsync(AccountOperationsComponent).then((fixture) => {
      fixture.detectChanges();
  ...
  it('should be enabled when conditions satisfied', injectAsync([AccountOperationsComponent], (tcb) => {
    return tcb.createAsync(AccountOperationsComponent).then((fixture) => {
      fixture.detectChanges();
...
describe('Close Account button', () => {
  ...
  it('should be disabled if accountId does not exist', injectAsync([AccountOperationsComponent], (tcb) => {
    return tcb.createAsync(AccountOperationsComponent).then((fixture) => {
      fixture.detectChanges();
  ...
  it('should be disabled if accountId does not have a zero balance', injectAsync([AccountOperationsComponent], (tcb) => {
    return tcb.createAsync(AccountOperationsComponent).then((fixture) => {
      fixture.detectChanges();
...
describe('Deposit button', () => {
  ...
  it('should be disabled if amount is not provided', injectAsync([AccountOperationsComponent], (tcb) => {
      return tcb.createAsync(AccountOperationsComponent).then((fixture) => {
      fixture.detectChanges();
  ...
  it('should be disabled if amount is negative', injectAsync([AccountOperationsComponent], (tcb) => {
    return tcb.createAsync(AccountOperationsComponent).then((fixture) => {
      fixture.detectChanges();
...
describe('Withdraw button', () => {
  ...
  it('should be disabled if account does not have enough funds to complete withdraw', injectAsync([AccountOperationsComponent], (tcb) => {
    return tcb.createAsync(AccountOperationsComponent).then((fixture) => {
      fixture.detectChanges();
...
describe('Transfer button', () => {
  ...
  it('should be disabled when transferToAccountId is not provided', injectAsync([AccountOperationsComponent], (tcb) => {
    return tcb.createAsync(AccountOperationsComponent).then((fixture) => {
      fixture.detectChanges();
  ...
  it('should be disabled if transferToAccountId does not exist', injectAsync([AccountOperationsComponent], (tcb) => {
    return tcb.createAsync(AccountOperationsComponent).then((fixture) => {
      fixture.detectChanges();
  ...
  it('should be disabled if account does not have enough funds to complete transfer', injectAsync([AccountOperationsComponent], (tcb) => {
    return tcb.createAsync(AccountOperationsComponent).then((fixture) => {
      fixture.detectChanges();
...
describe('closeAccount', () => {
  beforeEachProviders(() => {
    bank.openAccount(accountId,firstName,email,accountType);
  });
...
describe('withdraw', () => {
  beforeEachProviders(() => {
    bank.openAccount(accountId,firstName,email,accountType, amount);
  });
...
describe('transfer', () => {
  ...
  beforeEachProviders(() => {
    bank.openAccount(accountId,firstName,email,accountType, amount);
    bank.openAccount(transferToAccountId,firstName,email,accountType);
  });
...
function injectAsync(arg0: any[], arg1: (tcb: any) => any): (done: DoneFn) => Promise<void> {
  throw new Error('Function not implemented.');
}
