...
describe('clear', () => {
  beforeEachProviders(() => {
    Bank.clear();
    bank = new Bank().openAccount(accountId,firstName,email,'Saving');
  });
...
describe('openAccount', () => {
  ...
  it('should error if account already exists', () => {
    expect(() => bank.openAccount(accountId,firstName,email,'Saving', 0))
      .toThrowError(`An account with id of \'${accountId}\' already exists.`);
  });

  it('should error if initialBalance is negative', () => {
    expect(() => bank.openAccount('new-account',firstName,email,'Saving', -1))
  ...
  it('should error if initialBalance is a decimal number', () => {
    ...
    expect(() => bank.openAccount('new-account',firstName,email,'Saving', initialBalance))
      .toThrowError(
  ...
  it('should open account with correct balance', () => {
    ...
    bank.openAccount('account-2',firstName,email,'Saving', initialBalance);
  ...
  it('should emit to accountUpdates', () => {
     ...
     bank.openAccount('account-2',firstName,email,'Saving');
...
describe('transfer', () => {
  ...
  beforeEachProviders(() => {
    ...
    bank.openAccount(account2Id,firstName,email,'Saving', 0);
  });
...
describe('getAllAccounts', () => {
  ...
  it('should return the complete collection of accounts', () => {
    bank.openAccount('account-2',firstName,email,'Saving', 0);
...
describe('getTotalBankCurrency', () => {
  ...
  it('should return a total of all bank held currency', () => {
    ...
    bank.openAccount('account-2',firstName,email,'Saving', amount2);
