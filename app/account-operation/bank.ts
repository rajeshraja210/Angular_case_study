...
export class Bank {
  ...
  private static accounts: BankAccount[] = new Array<BankAccount>();

  public static clear() : void {
    Bank.accounts.length = 0;
  }

  public openAccount(accountId: string,firstName: string,email: string,accountType: string, initialBalance = 0) : Bank {
    ...
    Bank.accounts.push(new BankAccount(accountId,firstName,email,accountType, initialBalance));
  ...
  private getAccount(accountId: string, errorIfDoesNotExist = true) : BankAccount {
